...
<head>
	...
	<meta property="og:site_name" content="<?php  echo $site_info['site_name'];?>" /> <!-- website name -->
	<meta property="og:site" content="<?php  echo $site_info['site_name'];?>" /> <!-- website link -->
	<meta property="og:title" content="<?php  echo $site_info['site_name'];?>"/> <!-- title shown in the actual shared post -->
	<meta property="og:description" content="<?php  echo $site_info['discription'];?>" /> <!-- description shown in the actual shared post -->
	<meta property="og:image" content="" /> <!-- image link, make sure it's jpg -->
	<meta property="og:url" content="<?php  echo $site_info['url'];?>" /> <!-- where do you want your post to link to -->
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="<?php logout(); ?>">Logout</a>
                </li>
            </ul>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="text-container">
                            <h1><span class="turquoise"><?php echo $_SESSION['username']; ?></span> Page Template Free</h1>
